...
namespace CrystalCarCare.Controllers
{
    public class CarRentController : Controller
    {
        ...
        {
            new Car { Id = 1, Make = "Toyota", Model = "Camry", Year = 2022, RentalPricePerDay = 50.00m, ImageUrl = "https://via.placeholder.com/300x200?text=Toyota+Camry", IsAvailable = true },
            new Car { Id = 2, Make = "Honda", Model = "Civic", Year = 2021, RentalPricePerDay = 45.00m, ImageUrl = "https://via.placeholder.com/300x200?text=Honda+Civic", IsAvailable = false },
            new Car { Id = 3, Make = "Ford", Model = "Mustang", Year = 2023, RentalPricePerDay = 80.00m, ImageUrl = "https://via.placeholder.com/300x200?text=Ford+Mustang", IsAvailable = true },
            new Car { Id = 4, Make = "Tesla", Model = "Model 3", Year = 2024, RentalPricePerDay = 100.00m, ImageUrl = "https://via.placeholder.com/300x200?text=Tesla+Model+3", IsAvailable = true }
        };
