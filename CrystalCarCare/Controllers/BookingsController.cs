...
namespace CrystalCarCare.Controllers
{
    ...
    public class BookingsController : Controller
    {
        ...
        // GET: Bookings/Create
        // GET: Booking/Create
        public ActionResult Create(string serviceName, decimal? price)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public ActionResult Edit([Bind(Include = "BookingId,ServiceName,Price,Name,Phone,CreatedAt")] Booking booking)
        {
            if (ModelState.IsValid)
            {
